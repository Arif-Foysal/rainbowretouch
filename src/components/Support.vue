    ...
    <div>
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="text-center">
                <h2 class="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-6xl font-pj">Make every step user-centric</h2>
                <p class="mt-4 text-lg leading-7 text-gray-600 sm:mt-8 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit</p>
            </div>
            ...
            <div class="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
                <div class="md:p-8 lg:p-14">
                    ...
                    <h3 class="mt-12 text-2xl font-bold text-gray-900 font-pj">Support</h3>
                ...
                <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                    ...
                    <h3 class="mt-12 text-2xl font-bold text-gray-900 font-pj">Sales</h3>
                    <p class="mt-5 text-base text-gray-600 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
                </div>
                ...
                <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                    ...
                    <h3 class="mt-12 text-2xl font-bold text-gray-900 font-pj">Onboarding</h3>
                    <p class="mt-5 text-base text-gray-600 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
                </div>
                ...
                <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                    ...
                    <h3 class="mt-12 text-2xl font-bold text-gray-900 font-pj">Quality</h3>
                    <p class="mt-5 text-base text-gray-600 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
                </div>
                ...
                <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                    ...
                    <h3 class="mt-12 text-2xl font-bold text-gray-900 font-pj">Result</h3>
                    <p class="mt-5 text-base text-gray-600 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
                </div>
            </div>
        </div>
