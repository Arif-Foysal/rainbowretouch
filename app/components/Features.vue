...
const features = [
  {
    icon: 'i-lucide-truck',
    title: 'Fast Delivery',
    description: 'Quick turnaround on all editing projects',
    color: 'blue'
  },
  {
  ...
  },
  {
    ...
    description: 'Your images remain confidential',
    color: 'red'
  },
  {
    icon: 'i-lucide-tag',
  ...
  },
  {
    ...
    title: 'High Volume Editing',
    description: 'Capable of handling large batches',
    color: 'indigo'
  },
  {
  ...
  },
  {
    ...
    description: 'Expert professionals for your projects',
    color: 'pink'
  },
  {
    icon: 'i-lucide-message-circle',
    title: 'Live Chat',
    description: 'Instant communication for your queries',
    color: 'cyan'
  },
  {
    icon: 'i-lucide-lock',
...
<template>
  ...
  <div class="space-y-12">
    ...
    <div class="relative group">
      <div class="absolute inset-0 bg-gradient-to-r from-primary/20 to-purple-500/20 rounded-3xl blur-3xl group-hover:blur-2xl transition-all duration-500 opacity-50"></div>
        ...
        <div class="aspect-[21/9] relative">
          ...
          <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent flex items-end transform transition-transform duration-700 group-hover:scale-110">
            <div class="p-8 lg:p-12 text-white max-w-2xl">
              <div class="inline-block px-4 py-1 bg-primary/90 rounded-full text-sm font-medium mb-4">
                Stunning Quality
              </div>
              <h2 class="text-4xl lg:text-5xl font-bold mb-4">Professional Photo Editing Services</h2>
              <p class="text-lg text-gray-200">Transform your product images with our expert editing team</p>
            </div>
          </div>
        </div>
      </UCard>
